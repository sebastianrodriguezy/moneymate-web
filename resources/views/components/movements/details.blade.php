<template x-if="dataDrawer">
  <div class="w-full flex flex-col gap-3 p-4 mt-4 leading-4 border dark:border-gray-700 rounded-md">
    ...
    <div class="w-full flex flex-row items-center">
      <p class="text-center font-normal mr-2">Tipo:</p>
    ...
    <div class="w-full flex flex-row items-center">
      <p class="text-center font-normal mr-2">Cantidad:</p>
      <span 
    ...
    <div class="w-full flex flex-row items-center">
      <p class="text-center font-normal mr-2">Category:</p>
      <div 
    ...
    <div class="w-full flex flex-row items-center">
      <p class="text-center font-normal mr-2">Persona:</p>
      <span 
        class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-300"
        x-text="dataDrawer.person ? dataDrawer.person : 'No especificado'"
      >
      </span>
    </div>

    <div class="w-full flex flex-row items-center">
      <p class="text-center font-normal mr-2">Comentarios:</p>
