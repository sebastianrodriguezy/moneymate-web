  ...
  <div x-show="showModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
      ...
      <div x-cloak x-show="showModal" x-transition:enter="transition ease-out duration-300 transform"
        ...
        class="w-full max-w-xl p-5 overflow-hidden text-left transition-all transform bg-gray-50 dark:bg-gray-800 rounded-md shadow-xl 2xl:max-w-2xl">
        <div class="flex items-center justify-between space-x-4">
          <h2 class="text-xl font-medium text-gray-800" x-text="titleModal"></h2>
        ...
        <p class="mt-2 text-sm text-gray-500" x-text="subtitleModal"></p>
        ...
        <div class="flex flex-row items-center justify-end mt-6">
          <button type="button"
            class="text-white bg-brand-500 hover:bg-brand-600 focus:ring-4 focus:ring-brand-300 font-medium rounded-md text-sm px-5 py-2 mr-3 dark:bg-brand-600 dark:hover:bg-brand-700 focus:outline-none dark:focus:ring-brand-800">Guardar</button>
